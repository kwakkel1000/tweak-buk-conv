#include "../../include/TweakPermissionsConvert.h"
...
{
    return new TweakPermissionsConvert;
}
...
TweakPermissionsConvert::TweakPermissionsConvert()
{
}
...
void TweakPermissionsConvert::Init()
{
...
void TweakPermissionsConvert::stopthreadloop()
{
    runthreadloop = false;
    cout << "notify" << endl;
}

void TweakPermissionsConvert::threadloop()
{
	GetGroupsDB();
	GetZoneDataDB();
	ParseZoneDataDB();
    ...
    cout << "void TweakPermissionsConvert::threadloop() end" << endl;
}

void TweakPermissionsConvert::GetGroupsDB()
{
...
void TweakPermissionsConvert::GetZoneDataDB()
{
	std::vector< std::vector< std::string > > sql_result;
...
void TweakPermissionsConvert::ParseZoneDataDB()
{
...
void TweakPermissionsConvert::add_zone(std::string id, std::string name, std::string minz, std::string maxz, std::string tnt, std::string health)
{
    int i = get_zone(id);
    if (i == -1)
    {
...
void TweakPermissionsConvert::add_zone_vertice(std::string id, std::string x, std::string y)
{
    int i = get_zone(id);
    if (i != -1)
    {
...
void TweakPermissionsConvert::add_zone_users(std::string id, std::string m_admins, std::string m_users)
{
    int i = get_zone(id);
    if (i != -1)
    {
...
int TweakPermissionsConvert::get_zone(std::string id)
{
